...
const ImageUploading = ({route,navigation}) => {
  ...
  const uploadImage=async(image_uri) =>{
      ...
      let base_url="https://lrtextile.com.pk/projectmart/pitcher/profile_image.php?uemail="+myEmail;
      let uploadData=new FormData();
      uploadData.append('submit','ok');
      uploadData.append('file',{type:'image/jpeg',uri:image_uri,name:'uploadimage.jpg'});
      ...
      .then((response) =>
       {
           if(response.status)
           {
              ...
              navigation.navigate("CnicImage",{myEmail : myEmail,type:type});
           }
           else{
