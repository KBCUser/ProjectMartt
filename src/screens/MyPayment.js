...
const MyPayment = ({route,navigation}) => {
  const myEmail=route.params.myEmail; 
  const [productdata,setproductdata] = useState("");

  var fetchInsertApi="https://lrtextile.com.pk/projectmart/pitcher/get_myreleaseamount.php?uemail="+myEmail;
      var headers={
    ...
    return (
      <View> 
        <View >
      <Text style={{marginTop:10,fontSize:20,color:"#f9b347",alignContent:'center',justifyContent:'center',textAlign:'center'}}>My Payment List</Text>
     ...
     renderItem={(element)=>{
         return (
          ...
          <View style={styles.item1}>
           <Image style={styles.imagestyle}  source={require("../../assets/payment.png")} />
          ...
          >
           ...
           <Text> Amount  : Rs {element.item.amount_release}</Text>
