...
const PitcherProjectManagement = ({route,navigation}) => {
    ...
    return (
     ...
     renderItem={(element)=>{
         return (
          ...
          <TouchableOpacity
          onPress={() => navigation.navigate("ViewMilestone",{idea_id : element.item.idea_id,myEmail:myEmail})}>
           ...
           <Text style={{color:'#f9b347',textAlign:'center',marginTop:7,fontWeight:'bold'}}>+Click Box To View Milestone</Text>
...
export default PitcherProjectManagement;