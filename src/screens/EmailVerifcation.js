...
const EmailVerifcation = ({route,navigation}) => {
    ...
    const submit= () =>{
        if(verifyCode !="")
        {
        var fetchInsertApi="https://lrtextile.com.pk/projectmart/pitcher/email_verification.php";
        var headers={
            ...
            .then((response) =>
             {
                 ...
                 {
                    navigation.navigate("ImageUploading",{myEmail : myEmail,type:type});
                 }
                 else{
