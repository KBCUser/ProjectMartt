...
const CnicImage2 = ({route,navigation}) => {
  ...
  const uploadImage=async(image_uri) =>{
      ...
      let base_url="https://lrtextile.com.pk/projectmart/pitcher/cnic_image2.php?uemail="+myEmail;
     ...
     return (
        ...
        <View style={styles.mainscreen}>
            ...
            <View>
            <Text style={styles.mainhaider}>Cnic Back Image Upload</Text>
            </View>
