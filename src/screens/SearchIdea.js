...
const SearchIdea = ({route,navigation})=>{
  ...
  const searhKeyword=route.params.searhKeyword;
    ...
    var fetchInsertApi2="https://lrtextile.com.pk/projectmart/investor/search_idea.php?ukeyword="+searhKeyword;
        var headers={
    ...
    <FlatList 
     ...
     renderItem={(element)=>{
         return (
          ...
          <Title style={{color:'black',padding:5,fontSize:15,fontWeight:'bold'}}> &nbsp;&nbsp;Idea Name : {element.item.idea_name}</Title>
          <Card.Cover source={{ uri: "https://lrtextile.com.pk/projectmart/pitcher/"+element.item.idea_img }} style={{height:175}}/>
          <Card.Content>
            
            <Paragraph  style={{color:'black',padding:5}}>Idea Category : {element.item.idea_category}{'\n'}
