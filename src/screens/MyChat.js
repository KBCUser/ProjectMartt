...
const MyChat = ({route,navigation}) => {
  const myEmail=route.params.myEmail; 
  const [productdata,setproductdata] = useState("");

  var fetchInsertApi="https://lrtextile.com.pk/projectmart/chats/mychatmaster.php?uemail="+myEmail;
      var headers={
         ...
         return (
          ...
          <View style={styles.item2}>
           ...
           <Text style={{color:'#f9b347',textAlign:'center',marginTop:7,fontWeight:'bold'}}
            onPress={() => navigation.navigate("ChatMessenger",{sendemail : `${myEmail}`,recemail:element.item.rec_email})}>+Click to Chat Now</Text>
