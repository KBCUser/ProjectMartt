...
const InvestorMainScreen = ({route,navigation})=>{
  const myEmail=route.params.myEmail;
    ...
    <View style={styles.item}>
        <TouchableOpacity 
        onPress={()=> navigation.navigate("SearchIdea",{searhKeyword : searchQuery,myEmail:myEmail})}
        style={{marginTop:23}}>
...
export default InvestorMainScreen;