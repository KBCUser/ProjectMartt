    ...
    const submit= () =>{
        if(userName !="" || userEmail !="" || password !="" || phoneNo !="" || userAddress !="" || bankname !=""  || accountnumber !="")
        {
            if(password.length >= 6)
         {
            ...
            {
        var fetchInsertApi="https://lrtextile.com.pk/projectmart/investor/investor_register.php";
        var headers={
            ...
            .then((response) =>
             {
                 if(response[0].Message == "Investor has been Register")
                 {
                    ...
                    navigation.navigate("EmailVerifcation",{myEmail : `${userEmail}`,type:'investor'});
                 }
                else if(response[0].Message == "Email Already Exist")
                 {
                    alert('Email Already Exist Please Try Again');
                 }
                else if(response[0].Message == "Investor Not been Register Please Try Again"){
      ...
      return(
        ...
        <View style={styles.mainscreen}>
         ...
         <View>
             <Text style={styles.registerbutton2}>Register as a Pitcher ?
