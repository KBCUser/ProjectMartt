...
const AddMilestoneWork = ({route,navigation}) => {
    ...
    const submit= () =>{
        if(milestonedetail !="" )
        {
        var fetchInsertApi="https://lrtextile.com.pk/projectmart/pitcher/add_milestonework.php";
        var headers={
            ...
            .then((response) =>
             {
                 if(response[0].Message == "Idea has been Register")
                 {
                    ...
                    navigation.navigate("ViewMilestone",{myEmail : myEmail,idea_id:idea_id});
                 }
                 else{
                  alert('Milestone Not been Uploaded Please Try Again');
                 }
             }
            ).catch((error) =>
            {
  ...
  const uploadImage=async(image_uri) =>{
      ...
      let base_url="https://lrtextile.com.pk/projectmart/pitcher/uploadmilestonepic.php";
     ...
     return (
        ...
        <View style={styles.mainscreen}>
            ...
            <View>
            <Text style={styles.mainhaider}>Add Milestone Work</Text>
            </View>

      
            <View>
             <Text style={styles.labels}>Milestone Detail</Text>
             <TextInput 
              ...
              onChangeText={(actualdata) => setmilestonedetail(actualdata)}
             />
         </View>
       ...
       >
        ...
        onPress={() => submit()}
       >
           <Text style={styles.buttonstyle}>Add Work</Text>
 ...
 export default AddMilestoneWork;